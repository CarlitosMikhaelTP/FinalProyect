                ...
                <div class="col-lg-6  col-12 d-flex justify-content-center align-items-center box_main_form ">
                    ...
                    <div class="div_login d-flex justify-content-center flex-column ">
                        ...
                        <div class="h-75">
                            ...
                            <form action="">
                                ...
                                <div class="text-center login_div_input">
                                    <a href="comiteMenu.html"><input type="button" value="IngresarComité" class="login_btn"></a>
                                </div>

                                <div class="text-center login_div_input">
                                    <a href="menuprofesores.html"><input type="button" value="IngresarDocente" class="login_btn"></a>
                                </div>


                                <div class="text-center login_div_input">
                                    <a href="home_alumno.html"><input type="button" value="IngresarEstudiante" class="login_btn"></a>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="d-flex align-items-end justify-content-center">
                            ...
                            <a  class="d-flex texto_enlace" href="registro_tipo.html">
